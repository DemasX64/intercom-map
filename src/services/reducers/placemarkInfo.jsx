...
const placemarkInfoSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(getPlacemarks.pending, (state) => {
    ...
    builder.addCase(getPlacemarks.rejected, (state) => {
      state.getPlacemarksRequest = false;
    });
    builder.addCase(addPlacemarkToMap.pending, () => {
    });
    ...
    builder.addCase(addPlacemarkToMap.rejected, () => {
    });
  },
});

export const {
  setCode, showInfo, hideInfo, setPlacemarkID,
